...
def run_page(routine_name):
    ...
    while is_continue:
        ...
        print("01 Selesai")
        print("02 Ceklis semua exercise")
            ...
            match user_option:
                ...
                case _:
                    ...
                    if len(user_option) > 2:
                        ...
                        continue
                    try:
                        user_option[0] = int(user_option[0])+1 # karena indeks isi ruitnitas dimulai dari 2
                    except:
